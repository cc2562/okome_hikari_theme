        ...
        var e = function () {
            function e(t) {
                ...
                var s = {
                    ...
                    width: "100%",
                    maxHeight: "250px",
                    api: (document.location.origin.replace(/\/$/, "") + "/okome-hikari-api/owo")
                };
            ...
            return _createClass(e, [{
                ...
                value: function (e) {
                    ...
                    for (var a = '\n            <div class="OwO-logo"><span>' + e.logo + '</span></div>\n            <div class="OwO-body" style="width: ' + e.width + '">',
                        ...
                        for (var n = this.odata[this.packages[s]].container, i = 0; i < n.length; i++) a += '\n                    <li class="OwO-item" title="' + n[i].text + '" data-input="' + (n[i].input || '') + '">' + (this.odata[this.packages[s]].type === "image" ? (n[i].icon && n[i].icon.indexOf('<img') > -1 ? n[i].icon : '<img src="' + n[i].icon + '" alt="' + (n[i].text || '') + '" class="owo-emoji">') : n[i].icon) + "</li>";
                        a += "\n                </ul>"
                    }
                            ...
                            function (e) {
                                ...
                                if (e.target.classList.contains("OwO-item") ? a = e.target : e.target.parentNode.classList.contains("OwO-item") && (a = e.target.parentNode), a) {
                                    var s = t.area.selectionEnd,
                                        n = t.area.value,
                                        r = a.getAttribute("data-input") || a.innerHTML;
                                    t.area.value = n.slice(0, s) + r + n.slice(s),
                                        t.area.focus(),
                                        t.toggle()
                                }
                            }),
